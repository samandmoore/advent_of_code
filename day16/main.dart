...
void main() {
  // print(
  //   sumPacketVersions(parsePacket(convertPacketHexToBinary("D2FE28"))),
  // );
  // print("-----------------------");

  // print(
  //   sumPacketVersions(
  //     parsePacket(convertPacketHexToBinary("38006F45291200")),
  //   ),
  // );
  // print("-----------------------");
  ...
  // print(
  //   sumPacketVersions(
  //     parsePacket(convertPacketHexToBinary("EE00D40C823060")),
  //   ),
  // );
  // print("-----------------------");
  ...
  // print(
  //   sumPacketVersions(
  //     parsePacket(convertPacketHexToBinary("8A004A801A8002F478")),
  //   ),
  // );
  // print("-----------------------");
  ...
  // print(
  //   sumPacketVersions(
  //     parsePacket(convertPacketHexToBinary("620080001611562C8802118E34")),
  //   ),
  // );
  // print("-----------------------");

  // final packets =
  //     parsePacket(convertPacketHexToBinary("C0015000016115A2E0802F182340"));
  // print(
  ...
  // print(
  //   sumPacketVersions(
  //     parsePacket(convertPacketHexToBinary("A0016C880162017C3686B18A3D4780")),
  //   ),
  // );
  // print("-----------------------");
...
Packet? parsePacket(List<String> packetInBinary) {
  ...
  if (typeId == 4) {
    ...
    return Packet(
      ...
      subPackets: [if (subPacket != null) subPacket],
    );
  } else {
    // operator
    ...
    if (lengthTypeIdBit == '0') {
      ...
      final subPacket = parsePacket(subpacketBits);
      final otherSubPacket = parsePacket(packetInBinary);

      return Packet(
        version: version,
        typeId: typeId,
        subPackets: [
          if (subPacket != null) subPacket,
          if (otherSubPacket != null) otherSubPacket,
        ],
      );
